...
namespace SoftwareKobo.Icons.FontAwesome
{
    ...
    {
        public static readonly DependencyProperty SymbolProperty = DependencyProperty.Register(nameof(Symbol), typeof(FontAwesomeSymbol), typeof(FontAwesomeIcon), new PropertyMetadata(default(FontAwesomeSymbol), OnSymbolChanged));
