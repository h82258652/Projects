...
namespace SoftwareKobo.Icons.MaterialIcons
{
    ...
    {
        public static readonly DependencyProperty SymbolProperty = DependencyProperty.Register(nameof(Symbol), typeof(MaterialSymbol), typeof(MaterialIcon), new PropertyMetadata(default(MaterialSymbol), OnSymbolChanged));
