...
namespace SoftwareKobo.Icons.Dashicons
{
    ...
    {
        public static readonly DependencyProperty SymbolProperty = DependencyProperty.Register(nameof(Symbol), typeof(DashSymbol), typeof(DashIcon), new PropertyMetadata(default(DashSymbol), OnSymbolChanged));
