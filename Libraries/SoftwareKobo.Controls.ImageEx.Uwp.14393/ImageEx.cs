...
namespace SoftwareKobo.Controls
{
    ...
    public class ImageEx : Control
    {
        ...
        public static readonly DependencyProperty SourceProperty = DependencyProperty.Register(nameof(Source), typeof(string), typeof(ImageEx), new PropertyMetadata(default(string), OnSourceChanged));
